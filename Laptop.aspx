<%@ Page Title="" Language="VB" MasterPageFile="~/site.master" AutoEventWireup="false" CodeFile="Laptop.aspx.vb" Inherits="Laptop" %>
...
<asp:DataList ID="DataList1"  runat="server"  DataSourceID="tblmobile" RepeatColumns="3" CellPadding="25" 
    ...
    <center >
        <asp:Image ID="Image1" runat="server"  ImageUrl='<%# Eval("Proimage", "{0}") %>' Height="250px" Width="250px" />
        <br /> <br /><br />
    ...
    <SelectedItemStyle BackColor="#FFCC66" Font-Bold="True" ForeColor="Navy" />
      ...
      <asp:AccessDataSource ID="tblmobile" runat="server" DataFile="~/App_Data/electoshop.accdb" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Laptop" Name="Category" Type="String" />
        </SelectParameters>
